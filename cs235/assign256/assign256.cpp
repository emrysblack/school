...
class I
{
   private:
      ...
      I* mother;
   public:
   I(string fName, string lName, string date, string num){firstName = fName; lastName = lName; birthdate = date; id = num; father = NULL; mother = NULL;};
      ...
      I* getFather(void){return father;};
      I* getMother(void){return mother;};
      ...
      void setFather(I* ind){father = ind;};
      void setMother(I* ind){mother = ind;};
};
   ...
   if (!names.empty())
   {
      ...
      while (!done and right != names.end())
      {
         ...
         if (ind->getLastName() != right->getLastName())
         {
            ...
            compare1[0] = toupper(compare1[0]);
            compare2[0] = toupper(compare2[0]);
...
void parse(list < string > &record, list < I > &names)
{
   ...
   if (in[1] == 'I')
   {
      ...
      I ind(firstName, lastName, birthdate, id);
      insert(&ind, names);
   }
   else if (in[1] == 'F')
   {
...
int main(int argc, char** argv)
{
   ...
   else
   {
      ...
      {
         out << name->getFirstName() << name->getLastName()
             << name->getBirthdate() << endl;
      }
      out.close();
   }
   return 0;

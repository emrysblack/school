...
*    Brady Field
* Summary: 
*    This program is designed to demonstrate simple inheritance through
*    an Time class, inheriting off a Minutes parent, inheriting off a
*    Hours parent.
*
*    Estimated:  1.0 hrs   
*    Actual:     2.0 hrs
*      Getting the addition to minutes perfectly
************************************************************************/
